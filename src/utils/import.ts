...
// Convert OpenAI chat format to rootGPT format
export const convertOpenAITorootGPTFormat = (
...
// Import OpenAI chat data and convert it to rootGPT format
export const importOpenAIChatExport = (openAIChatExport: OpenAIChat[]) => {
  return openAIChatExport.map(convertOpenAITorootGPTFormat);
};
